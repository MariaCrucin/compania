...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20220114092534_UniqueInTarife")]
    partial class UniqueInTarife
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Coordonator", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.Serviciu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.Tarif", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("ClientId", "ServiciuId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Core.Entities.Tarif", b =>
                {
                    ...
                    b.HasOne("Core.Entities.Serviciu", "Serviciu")
                        .WithMany("Tarife")
